...
// --- FIM DOS DADOS FIXOS ORIGINAIS ---

document.addEventListener('DOMContentLoaded', () => {
    // IMPORTANTE: Remova a linha 'import supabase from './supabase.js';' se ela estiver aqui.
    // E remova as chamadas ao Supabase (fetchPartners e initializeApp), voltando
    // a chamar as funções de renderização diretamente.
...
        // Adicionando a URL completa para o Google Maps (Ajuste o {encodeURIComponent} se necessário)
...
    // Zera o conteúdo anterior
    ...
    if (partner.instagram) {
        ...
        // Você precisará garantir que 'imagens/icons/Instagram_icon.png' exista
    ...
    // Você pode adicionar o link do Facebook aqui também
    /*
    if (partner.facebook) {
